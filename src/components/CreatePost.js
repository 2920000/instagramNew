...
function CreatePost() {
  ...
  return <div className=''>
      <div   className='fixed  flex justify-center items-center top-0 right-0 bottom-0 left-0 z-30  bg-overlayColor mix-blend-multiply  '>
    ...
    <div ref={overlayRef} className='fixed flex z-50 top-0 right-0 left-0 bottom-0 justify-center items-center'>
