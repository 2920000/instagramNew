          ...
          <div>
            <div className="mt-5">
              <div className="text-[0.70rem] text-greyColor">
                Giới thiệu &middot; Trợ giúp &middot; Báo chí &middot;
                API&middot; Việc làm &middot;
              </div>
              <div className="text-[0.70rem] text-greyColor">
                Quyền riêng tư &middot; Điều khoản &middot; Vị trí &middot;{" "}
              </div>
              <div className="text-[0.70rem] text-greyColor">
                Tài khoản liên quan nhất &middot; Hashtag &middot; Ngôn ngữ{" "}
              </div>
            </div>
