...
function UnFollowBoxWithOverlay() {
  ...
  const handleUnfollow = () => {
    dispatch(
      actionUpdateFollow(
        unFollowBox.dataToUpdateFollowStatus.loginUserFullData,
        unFollowBox.dataToUpdateFollowStatus.userClickedToUnfollow
      )
    );
    dispatch(
      UNFOLLOW_BOX({
              ...
              <div className="flex flex-col items-center gap-y-5 grow justify-center">
                <span>
                  <img
                    ...
                    src={unFollowBox.dataUserToUnfollow.avatar}
                    alt=""
                  />
                </span>
                <span className="text-sm">
                  Bỏ theo dõi {unFollowBox.dataUserToUnfollow.userName}?
                </span>
              </div>
              <div>
                <div
                  onClick={handleUnfollow}
                  className="py-3 border-t border-borderColor text-center  font-bold text-sm cursor-pointer text-[#ED4956] active:bg-greyLightColor "
                >
                  Bỏ theo dõi
                </div>
                <div
                  onClick={handleOffBox}
                  className="py-3 border-t border-borderColor text-center cursor-pointer active:bg-greyLightColor rounded-b-xl "
                >
                  Hủy
                </div>
              </div>
