...
import {
  selectAllUserExceptLoginUser,
  selectLoginUserFullData,
} from "../features/usersSilce";
    ...
    return (
      <div className="pt-[55px] max-w-[600px] m-auto ">
        ...
        <div className="border border-borderColor py-2">
          {allUsersExceptLoginUser.map((user) => (
            <div
            ...
            >
              ...
              <div>
                {followingArrayOfLoginUser.some(
                  ...
                  <span
                    ...
                    className="text-sm font-medium border border-borderColor rounded py-1.5 px-2.5 cursor-pointer"
                  >
                    Đang theo dõi
                  </span>
                ) : (
                  <span
                    ...
                    className="py-1.5 px-2.5 cursor-pointer  rounded-md bg-textFollowColor text-whiteColor font-medium text-sm"
                  >
                    Theo dõi
                  </span>
                )}
          ...
          {followingArrayOfLoginUser.length > 0 ? (
            <div className="py-2 px-4 mt-5">
              <div
                ...
                className="bg-textFollowColor rounded py-1.5  cursor-pointer font-medium text-sm text-center text-whiteColor"
              >
                Bắt đầu
              </div>
            </div>
